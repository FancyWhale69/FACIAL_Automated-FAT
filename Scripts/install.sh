...
echo "do you want to install the envs?"

nvd=1

select yn in "Yes" "No"; do
    case $yn in
        Yes ) conda env create -f ../envs/deep.yml; conda env create -f ../envs/mtcnn.yml; conda env create -f ../envs/facial.yml; nvd=0; break;;
        No ) break;;
    esac
done
...
cd ..
git clone https://github.com/zhangchenxu528/FACIAL.git
